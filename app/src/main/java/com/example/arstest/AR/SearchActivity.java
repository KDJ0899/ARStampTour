...
import com.example.arstest.Activity.landmarkDetail;
...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arsearch);
        ...
        intent = getIntent();
        id = intent.getStringExtra("att_id");
        ...
        if(requestCode==1){
            if(resultCode==RESULT_OK){
                ...
                if (result.equals("Yes")){
                    ...
                    cv.put("into","STAMP");
                    cv.put("values","0,date_format(now(),'%Y-%m-%d'),1,"+id);
                    NetworkTask networkTask = new NetworkTask(DataStorage.ipAdress+"/users/insert",cv);
                    networkTask.execute();
                    intent = new Intent(this, landmarkDetail.class);
